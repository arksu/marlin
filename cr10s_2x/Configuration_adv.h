...
#define EXTRUDER_AUTO_FAN_SPEED 105   // 255 == full speed
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 30*60, 30*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
