 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 220, 25 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE)-56
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 11    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 11    // Y point for Z homing when homing all axes (G28).
#endif
